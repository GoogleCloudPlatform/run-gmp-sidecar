module github.com/GoogleCloudPlatform/run-gmp-sidecar/collector/internal/tools

go 1.25.0

require (
	github.com/GoogleCloudPlatform/opentelemetry-operations-collector v0.141.0
