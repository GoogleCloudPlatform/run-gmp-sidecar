...
var testMetadata = map[string]scrape.MetricMetadata{
	...
	"example_process_start_time_seconds": {MetricFamily: "example_process_start_time_seconds",
		Type: model.MetricTypeGauge, Help: "", Unit: ""},
	"process_start_time_seconds": {MetricFamily: "process_start_time_seconds",
		Type: model.MetricTypeGauge, Help: "", Unit: ""},
	"subprocess_start_time_seconds": {MetricFamily: "subprocess_start_time_seconds",
		Type: model.MetricTypeGauge, Help: "", Unit: ""},
}
