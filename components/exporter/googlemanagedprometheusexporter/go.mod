module github.com/GoogleCloudPlatform/run-gmp-sidecar/components/exporter/googlemanagedprometheusexporter
...
require (
	...
	github.com/GoogleCloudPlatform/run-gmp-sidecar v0.0.0-20260108203931-def3130373b6
